...
abstract class MywpThirdpartyAbstractModule {
  ...
  protected static $thirdparty_base_name;

  protected static $thirdparty_name;
  ...
  public static function init() {
    ...
    if( empty( static::$thirdparty_base_name ) ) {

      $called_text = sprintf( 'class %s' , $class );

      MywpHelper::error_require_message( '"static protected $thirdparty_base_name"' , $called_text );

      return false;

    }

    if( empty( static::$thirdparty_name ) ) {

      $called_text = sprintf( 'class %s' , $class );

      MywpHelper::error_require_message( '"static protected $thirdparty_name"' , $called_text );
    ...
    add_filter( 'mywp_thirdparty_pre_plugin_activate_' . static::$thirdparty_base_name , array( $class , 'current_pre_plugin_activate' ) );
  ...
  public static function mywp_thirdparties( $thirdparties ) {
    ...
    $thirdparties[ static::$id ] = static::$thirdparty_base_name;
  ...
  protected static function is_current_plugin_activate() {
    ...
    return MywpThirdparty::is_plugin_activate( static::$thirdparty_base_name );
