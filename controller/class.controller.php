...
final class MywpController {
  ...
  private static function get_model( $controller , $controller_id ) {
    ...
    $pre_model = apply_filters( "mywp_controller_model_{$controller_id}" , false , $controller );
    $pre_model = apply_filters( 'mywp_controller_model' , $pre_model , $controller_id , $controller );
    ...
    $mywp_model = new MywpModel( $controller_id , $controller['model_use_filter'] , $controller['network'] );
