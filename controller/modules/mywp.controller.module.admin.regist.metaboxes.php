...
if ( ! class_exists( 'MywpControllerModuleRegistAdminRegistMetaboxes' ) ) :

final class MywpControllerModuleRegistAdminRegistMetaboxes extends MywpControllerAbstractModule {
  ...
  public static function regist_meta_boxes() {
    ...
    foreach( $current_meta_boxes as $context => $priority_meta_boxes ) {
      ...
      foreach( $priority_meta_boxes as $priority => $meta_boxes ) {
        ...
        foreach( $meta_boxes as $meta_box_id => $meta_box ) {
          ...
          $data['regist_meta_boxes'][ $metabox_screen_id ][ $meta_box_id ] = array(
            'id' => $meta_box_id,
            'context' => $context,
            'priority' => $priority,
    ...
    $mywp_model->update_data( $data );

  }

}

MywpControllerModuleRegistAdminRegistMetaboxes::init();
