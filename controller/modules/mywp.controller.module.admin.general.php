...
final class MywpControllerModuleAdminGeneral extends MywpControllerAbstractModule {
  ...
  public static function mywp_wp_loaded() {
    ...
    add_filter( 'site_transient_update_core' , array( __CLASS__ , 'site_transient_update_core' ) );

    add_filter( 'site_transient_update_plugins' , array( __CLASS__ , 'site_transient_update_plugins' ) );

    add_filter( 'site_transient_update_themes' , array( __CLASS__ , 'site_transient_update_themes' ) );

    add_filter( 'wp_revisions_to_keep' , array( __CLASS__ , 'wp_revisions_to_keep' ) );
  ...
  private static function not_use_admin() {
    ...
    wp_redirect( do_shortcode( '[mywp_url site="1"]' ) );
  ...
  public static function site_transient_update_core( $site_transient ) {
  ...
  public static function site_transient_update_themes( $site_transient ) {
  ...
  public static function wp_revisions_to_keep( $revision_num ) {
  ...
  public static function custom_footer_text() {
    ...
    $custom_footer_text = do_shortcode( $setting_data['custom_footer_text'] );
