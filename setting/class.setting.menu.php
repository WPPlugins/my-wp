...
final class MywpSettingMenu {
  ...
  public static function add_menu( $setting_menu_id = false , $setting_menu = false ) {
    ...
    if( $setting_menu['main'] ) {
      ...
      $menu_hook_name = add_menu_page( $setting_menu['page_title'] , $setting_menu['menu_title'] , MywpApi::get_manager_capability() , $setting_menu['slug'] , $setting_menu['render_function'] );

    } else {

      $menu_hook_name = add_submenu_page( $setting_menu['parent'] , $setting_menu['page_title'] , $setting_menu['menu_title'] , MywpApi::get_manager_capability() , $setting_menu['slug'] , $setting_menu['render_function'] );
