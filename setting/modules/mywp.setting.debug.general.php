...
final class MywpSettingScreenDebugGeneral extends MywpAbstractSettingModule {
  ...
  public static function mywp_current_setting_screen_content() {
    ...
    <table class="form-table">
      <tbody>
        <tr>
          <th><?php printf( __ ( 'Show debugging %s' , 'mywp' ) , __( 'Users' ) ); ?></th>
          <td>
            ...
            <p class="mywp-description">
              ...
              <?php _e( 'Debugging for multiple users that enter the User ID with comma.' , 'mywp' ); ?>
            </p>
            <?php if( !empty( $setting_data['users'] ) ) : ?>
              <ul>
                <?php foreach( $setting_data['users'] as $user_id ) : ?>
                  ...
                  <?php else : ?>
                    <li>[<?php echo $user_id; ?>]<?php echo $user->display_name; ?>(<?php echo $user->user_login; ?>)</li>
                  <?php endif; ?>
                <?php endforeach; ?>
              </ul>
            <?php endif; ?>
