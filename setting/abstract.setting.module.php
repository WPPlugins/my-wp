...
abstract class MywpAbstractSettingModule {
  ...
  public static function init() {
    ...
    add_action( "mywp_load_setting_screen_{$class::$id}"  , array( $class , 'mywp_current_load_setting_screen' ) );

    add_action( 'mywp_ajax' , array( $class , 'mywp_ajax' ) , static::$priority );

    add_action( "mywp_admin_enqueue_scripts_{$class::$id}" , array( $class , 'mywp_current_admin_enqueue_scripts' ) );

    add_action( "mywp_admin_print_styles_{$class::$id}" , array( $class , 'mywp_current_admin_print_styles' ) );

    add_action( "mywp_admin_print_scripts_{$class::$id}" , array( $class , 'mywp_current_admin_print_scripts' ) );

    add_action( "mywp_admin_print_footer_scripts_{$class::$id}" , array( $class , 'mywp_current_admin_print_footer_scripts' ) );
    ...
    add_action( "mywp_setting_post_data_action_custom_{$class::$id}_update" , array( $class , 'mywp_setting_post_data_action_custom_update' ) , 9 );

    add_action( "mywp_setting_post_data_action_{$class::$id}_update" , array( $class , 'mywp_setting_post_data_action_update' ) , 9 );

    add_action( "mywp_setting_post_data_action_{$class::$id}_remove" , array( $class , 'mywp_setting_post_data_action_remove' ) , 9 );
  ...
  public static function mywp_setting_post_data_action_update( $validated_data ) {}

  public static function mywp_setting_post_data_action_remove( $validated_data ) {}

  public static function current_mywp_setting_screen_post_data_action( $validated_data ) {}
