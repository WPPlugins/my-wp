...
final class MywpPostTypeModuleAdminSidebar extends MywpPostTypeAbstractModule {
  ...
  public static function current_manage_posts_columns( $posts_columns ) {
    ...
    $posts_columns['default_menu'] = __( 'Default' );
  ...
  public static function current_manage_posts_custom_column( $column_name , $post_id ) {
    ...
    } elseif( $column_name == 'default_menu' ) {

      printf( 'Type:(%s)<br />' , $mywp_post->item_default_type );
      printf( 'ID:(%s)<br />' , $mywp_post->item_default_id );
      printf( 'Parent:(%s)<br />' , $mywp_post->item_default_parent_id );

    } elseif( $column_name == 'info' ) {

      printf( 'Capability:(%s)<br />' , $mywp_post->item_capability );
